...
namespace SistemaAPI.Data
{
    public class AppDBContext : DbContext
    {
        ...
        /// <summary>
        /// Configura las entidades del modelo y establece los datos iniciales (seed data) para roles, sistemas y usuarios.
        /// Define las claves primarias y los datos por defecto necesarios para el funcionamiento inicial del sistema.
        /// </summary>
